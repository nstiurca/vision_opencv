# -*- coding: utf-8 -*-
#
# cv3_bridge documentation build configuration file, created by
...
import roslib
roslib.load_manifest('cv3_bridge')
import sys, os
...
htmlhelp_basename = 'cv3_bridgedoc'
...
latex_documents = [
  ('index', 'cv3_bridge.tex', u'stereo\\_utils Documentation',
